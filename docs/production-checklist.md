...
- Programar respaldo diario de MySQL desde hPanel y retenerlo fuera de la cuenta de producción. Para un respaldo manual, ejecutar `scripts/backup-database.ps1 -DatabaseUrl $env:DATABASE_URL` desde un host que tenga `mysqldump`.
